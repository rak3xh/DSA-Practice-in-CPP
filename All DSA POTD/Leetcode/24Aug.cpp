...
public:
    ...
    {
        pair<long, long> palindromes = getPalindromes(n);
        long prevPalindrome = palindromes.first;
        long nextPalindrome = palindromes.second;
        long num = stol(n);

        return abs(prevPalindrome - num) <= abs(nextPalindrome - num)
